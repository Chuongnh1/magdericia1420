 ...
 */
class Wso_PaymentFilter_Model_Observer extends Mage_Core_Model_Abstract
{
	/**
	...
	public function controllerFrontInitBefore($observer)
	{
		...
		{
			Mage::getConfig()->setNode('global/helpers/payment/rewrite/data', 'Wso_PaymentFilter_Helper_Payment_Data');
		}
	}
